...
export default function Home() {
    ...
    const onePageContent = Array(3).fill(cppCode).join('\n');

    const content = [onePageContent, onePageContent, onePageContent];

    // Handle scroll to create infinite illusion
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            if (scrollTop < pageHeight * 0.1) {
                // Jump forward by one page height
            ...
            // If we scroll near the bottom (into the third block)
                ...
                // Jump backward by one page height
                container.scrollTop = scrollTop - pageHeight;
            }
        };
    ...
    // Set initial scroll position to the start of the middle block
    useLayoutEffect(() => {
        const container = containerRef.current;
        if (container) {
            const scrollHeight = container.scrollHeight;
    ...
    return (
        <div className="relative w-screen h-screen bg-[#0d1117] overflow-hidden"
            ...
            <div
                ...
                style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
            >
                <div className="w-full opacity-30 blur-[1px]">
            ...
            <div className="fixed inset-0 z-10 flex items-center justify-center pointer-events-none">
                <div className="text-center px-8">
                    <h1 className="text-6xl font-bold tracking-tight text-[#58a6ff] drop-shadow-2xl md:text-7xl lg:text-8xl" style={{ fontFamily: 'var(--font-space)' }}>
                        SFINAE
                    </h1>
                    <p className="mt-6 text-base text-[#8b949e] md:text-lg lg:text-xl font-medium tracking-wide" style={{ fontFamily: 'var(--font-space)' }}>
            ...
            <div className="fixed inset-0 bg-gradient-to-b from-[#0d1117]/40 via-transparent to-[#0d1117]/40 pointer-events-none z-5" />
        </div>
    );
}
